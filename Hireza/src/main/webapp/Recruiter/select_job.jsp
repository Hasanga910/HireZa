...
<%@ page import="model.User, dao.CompanyDAO, model.Company, dao.JobPostDAO, model.JobPost, java.util.List, dao.RecruiterDAO, model.Recruiter, dao.JobNotificationDAO, model.Notification2, java.text.SimpleDateFormat" %>
<%
    ...
    List<JobPost> posts = jobPostDAO.getAllJobPostsByCompanyId(recruiter.getCompanyId());
...
<div class="container">
    ...
    <main class="main-content" id="mainContent">
        ...
        <div class="job-posts-card">
            ...
            <% } %>
            <a href="${pageContext.request.contextPath}/Recruiter/recruiter_dashboard.jsp" class="btn btn-secondary">Back to Dashboard</a>
        </div>
    </main>
</div>
