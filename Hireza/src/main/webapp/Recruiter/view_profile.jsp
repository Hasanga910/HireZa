...
<%--<%@ page import="model.JobSeekerProfile, model.User" %>--%>
<%--<%--%>
...
<%--    <title>View Profile - Job Portal</title>--%>
...
<%--            <% if (profile == null) { %>--%>
<%--            <p class="no-profile">No profile found for this candidate.</p>--%>
<%--            <% } else { %>--%>
<%--            <div class="section">--%>
...
<%--            <div class="section">--%>
<%--                <h3>About</h3>--%>
<%--                <p><%= profile.getAbout() != null ? profile.getAbout() : "N/A" %></p>--%>
<%--            </div>--%>
<%--            <div class="section">--%>
<%--                <h3>Experience</h3>--%>
<%--                <p><%= profile.getExperience() != null ? profile.getExperience() : "N/A" %></p>--%>
<%--            </div>--%>
<%--            <div class="section">--%>
<%--                <h3>Education</h3>--%>
<%--                <p><%= profile.getEducation() != null ? profile.getEducation() : "N/A" %></p>--%>
<%--            </div>--%>
<%--            <div class="section">--%>
<%--                <h3>Skills</h3>--%>
<%--                <p><%= profile.getSkills() != null ? profile.getSkills() : "N/A" %></p>--%>
<%--            </div>--%>
<%--            <% if (profile.getProfilePic() != null) { %>--%>
<%--            <div class="section">--%>
<%--                <h3>Profile Picture</h3>--%>
<%--                <img src="${pageContext.request.contextPath}/<%= profile.getProfilePic() %>" alt="Profile Picture">--%>
<%--            </div>--%>
<%--            <% } %>--%>
<%--            <% } %>--%>
