...
<%--<%@ page import="model.User, dao.CompanyDAO, model.Company, model.JobPost, java.text.SimpleDateFormat" %>--%>
<%--<%--%>
...
<%--    JobPost post = (JobPost) request.getAttribute("post");--%>
<%--    SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");--%>
<%--    String deadlineStr = post.getApplicationDeadline() != null ? sdf.format(post.getApplicationDeadline()) : "";--%>
<%--%>--%>
<%--<!DOCTYPE html>--%>
<%--<html lang="en">--%>
<%--<head>--%>
...
<%--    <title>Edit Job Post - Job Portal</title>--%>
...
<%--            <li><a href="${pageContext.request.contextPath}/company/recruiter-activity"><i class="fas fa-eye"></i> <span>Monitor Recruiter Activity</span></a></li>--%>
<%--            <li class="sign-out">--%>
...
<%--            %>--%>
<%--            <p class="error">Error updating job. Please try again.</p>--%>
<%--            <% } %>--%>
<%--            <form action="${pageContext.request.contextPath}/company/jobs/edit" method="post" onsubmit="showNotification('Updating job post...')">--%>
<%--                <input type="hidden" name="jobId" value="<%= post.getJobId() %>">--%>
<%--                <div class="form-group">--%>
<%--                    <label for="jobTitle">Job Title *</label>--%>
<%--                    <input type="text" id="jobTitle" name="jobTitle" value="<%= post.getJobTitle() != null ? post.getJobTitle() : "" %>" required>--%>
<%--                </div>--%>
<%--                <div class="form-group">--%>
<%--                    <label for="workMode">Work Mode</label>--%>
<%--                    <select id="workMode" name="workMode">--%>
<%--                        <option value="">Select Work Mode</option>--%>
<%--                        <option value="onsite" <%= "onsite".equals(post.getWorkMode()) ? "selected" : "" %>>Onsite</option>--%>
<%--                        <option value="remote" <%= "remote".equals(post.getWorkMode()) ? "selected" : "" %>>Remote</option>--%>
<%--                        <option value="hybrid" <%= "hybrid".equals(post.getWorkMode()) ? "selected" : "" %>>Hybrid</option>--%>
<%--                    </select>--%>
<%--                </div>--%>
<%--                <div class="form-group">--%>
<%--                    <label for="location">Location (City/Country)</label>--%>
<%--                    <input type="text" id="location" name="location" value="<%= post.getLocation() != null ? post.getLocation() : "" %>">--%>
<%--                </div>--%>
<%--                <div class="form-group">--%>
<%--                    <label for="employmentType">Employment Type</label>--%>
<%--                    <input type="text" id="employmentType" name="employmentType" value="<%= post.getEmploymentType() != null ? post.getEmploymentType() : "" %>">--%>
<%--                </div>--%>
<%--                <div class="form-group">--%>
<%--                    <label for="jobDescription">Job Description</label>--%>
<%--                    <textarea id="jobDescription" name="jobDescription" rows="6"><%= post.getJobDescription() != null ? post.getJobDescription() : "" %></textarea>--%>
<%--                </div>--%>
<%--                <div class="form-group">--%>
<%--                    <label for="requiredSkills">Required Skills</label>--%>
<%--                    <textarea id="requiredSkills" name="requiredSkills" rows="4"><%= post.getRequiredSkills() != null ? post.getRequiredSkills() : "" %></textarea>--%>
<%--                </div>--%>
<%--                <div class="form-group">--%>
<%--                    <label for="experienceLevel">Experience Level</label>--%>
<%--                    <input type="text" id="experienceLevel" name="experienceLevel" value="<%= post.getExperienceLevel() != null ? post.getExperienceLevel() : "" %>">--%>
<%--                </div>--%>
<%--                <div class="form-group">--%>
<%--                    <label for="applicationDeadline">Application Deadline</label>--%>
<%--                    <input type="date" id="applicationDeadline" name="applicationDeadline" value="<%= deadlineStr %>">--%>
<%--                </div>--%>
<%--                <div class="form-group">--%>
<%--                    <label for="salaryRange">Salary Range</label>--%>
<%--                    <input type="text" id="salaryRange" name="salaryRange" value="<%= post.getSalaryRange() != null ? post.getSalaryRange() : "" %>">--%>
<%--                </div>--%>
<%--                <div class="form-group">--%>
<%--                    <label for="workingHoursShifts">Working Hours / Shifts</label>--%>
<%--                    <input type="text" id="workingHoursShifts" name="workingHoursShifts" value="<%= post.getWorkingHoursShifts() != null ? post.getWorkingHoursShifts() : "" %>">--%>
<%--                </div>--%>
<%--                <button type="submit" class="btn"><i class="fas fa-save"></i> Update Job</button>--%>
<%--            </form>--%>
<%--            <a href="${pageContext.request.contextPath}/company/jobs" class="btn back-btn" onclick="showNotification('Returning to Manage Jobs')"><i class="fas fa-arrow-left"></i> Back to Manage Jobs</a>--%>
<%--        </div>--%>
<%--    </main>--%>
<%--</div>--%>
...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<%@ page import="model.User, dao.CompanyDAO, model.Company, model.JobPost, java.text.SimpleDateFormat, dao.NotificationDAO, model.Notification" %>
...
<%
    ...
    companyId = (company != null) ? company.getCompanyId() : "0";
    session.setAttribute("companyId", companyId);
    ...
    unreadCount = notifDAO.getUnreadNotificationCount(companyId);
    notifications = notifDAO.getNotificationsByCompanyId(companyId);
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<script>
    ...
    function markAsRead(notificationId) {
        ...
        xhr.open('POST', '${pageContext.request.contextPath}/company/mark-notification-read', true);
    ...
    function markAllAsRead(companyId) {
        const xhr = new XMLHttpRequest();
        xhr.open('POST', '${pageContext.request.contextPath}/company/mark-all-notifications-read', true);
        xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4 && xhr.status === 200) {
                location.reload();
