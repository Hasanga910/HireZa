...
<%--<%@ page import="java.util.List, model.User, dao.UserDAO, model.Company, dao.CompanyDAO, model.JobPost, dao.JobPostDAO, java.util.ArrayList, java.util.Date, java.text.SimpleDateFormat, java.util.concurrent.TimeUnit" %>--%>
...
<%--    String companyLogo = (company.getLogo() != null) ? request.getContextPath() + "/company/logo?companyId=" + company.getCompanyId() : "https://via.placeholder.com/150?text=Logo";--%>
<%--    String companyName = (company.getCompanyName() != null) ? company.getCompanyName() : "Company Name";--%>
...
<%--    <title>Expired Job Posts - Job Portal</title>--%>
...
<%--        <div class="header">--%>
<%--            <h1><i class="fas fa-calendar-times"></i> Expired Job Posts</h1>--%>
<%--            <p>View and manage your expired job postings.</p>--%>
<%--        </div>--%>
...
<%--        <a href="${pageContext.request.contextPath}/company/jobs" class="btn btn-secondary" onclick="showNotification('Navigating to Manage Jobs')"><i class="fas fa-tasks"></i> Back to Manage Jobs</a>--%>

<%--        <!-- Expired Jobs Table -->--%>
<%--        <div style="margin-top: 2rem;">--%>
<%--            <h2 style="color: #dc3545; margin-bottom: 1rem; font-size: 1.4rem;">Expired Job Listings</h2>--%>
<%--            <% if (expiredPosts.isEmpty()) { %>--%>
<%--            <p class="no-posts">No expired job posts found.</p>--%>
<%--            <% } else { %>--%>
<%--            <table>--%>
<%--                <thead>--%>
<%--                <tr>--%>
...
<%--                    <td><%= post.getApplicationDeadline() != null ? sdf.format(post.getApplicationDeadline()) : "N/A" %></td>--%>
<%--                </tr>--%>
<%--                <% } %>--%>
<%--                </tbody>--%>
<%--            </table>--%>
