...
<%@ page import="model.User, dao.CompanyDAO, model.Company, dao.JobPostDAO, model.JobPost, java.util.List, dao.JobApplicationDAO" %>
<%
...
<head>
    ...
    <title>Select Job Post - Job Portal</title>
    ...
    <main class="main-content" id="mainContent">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <%
                        int applicantCount = appDAO.getApplicationsByJobId(post.getJobId()).size();
                    %>
                    <%= applicantCount %>
                </td>
                <td>
                    <a href="${pageContext.request.contextPath}/company/employer/applications?jobId=<%= post.getJobId() %>" class="btn" onclick="showNotification('Viewing applications for job: <%= post.getJobTitle() != null ? post.getJobTitle() : "N/A" %>')"><i class="fas fa-file-alt"></i> View Applications</a>
                </td>
            </tr>
            <% } %>
            </tbody>
...
<%@ include file="all_notifications_modal.jsp" %>
