...
<head>
    ...
    <title>Edit User Profile - Job Portal</title>
...
<%--            <li><a href="${pageContext.request.contextPath}/Employer/edit_user_profile.jsp"><i class="fas fa-user-edit"></i> <span>Edit User Profile</span></a></li>--%>
            ...
            <li><a href="${pageContext.request.contextPath}/Employer/edit_user_profile.jsp" class="active"><i class="fas fa-tachometer-alt"></i> <span>Edit User Profile</span></a></li>
    ...
    <main class="main-content" id="mainContent">
        ...
        <div class="form-container">
            ...
            <% } %>
            <form action="${pageContext.request.contextPath}/company/edit-user" method="post" onsubmit="return validateForm() && showNotification('Saving user profile...', 'info')">
                <div class="form-group">
                    <label for="fullName">Full Name *</label>
                    <input type="text" id="fullName" name="fullName" value="<%= employer.getFullName() != null ? employer.getFullName() : "" %>" required>
                </div>
                <div class="form-group">
                    <label for="username">Username *</label>
                    <input type="text" id="username" name="username" value="<%= employer.getUsername() %>" required>
                </div>
                <div class="form-group">
                    <label for="email">Email *</label>
                    <input type="email" id="email" name="email" value="<%= employer.getEmail() %>" required>
                </div>
                <div class="form-group">
                    <label for="phone">Phone</label>
                    <input type="text" id="phone" name="phone" value="<%= employer.getPhone() != null ? employer.getPhone() : "" %>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <a href="${pageContext.request.contextPath}/Employer/employer_dashboard.jsp" class="btn btn-secondary" onclick="showNotification('Returning to Dashboard', 'info')"><i class="fas fa-arrow-left"></i> Cancel</a>
                </div>
            </form>
        </div>
    </main>
...
<script>
    ...
    function validateForm() {
        ...
        // If password fields are empty, skip validation
        ...
        if (password !== confirmPassword) {
            ...
            showNotification('Password validation failed: Passwords do not match', 'error');
            return false;
        }
        ...
        if (!validatePassword(password)) {
            ...
            showNotification('Password validation failed: Requirements not met', 'error');
            return false;
        }
    ...
    // Clear requirements and error message when confirm password is changed
    document.getElementById('confirmPassword').addEventListener('input', function() {
        document.getElementById('passwordError').textContent = "";
        // Reset requirements to default state if password field is empty
